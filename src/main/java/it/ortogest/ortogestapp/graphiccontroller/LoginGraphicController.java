 ...
 * In questo modo il controller ha la singola responsabilitÃƒÂ  di orchestrare le
 * azioni della GUI.
 */
public class LoginGraphicController {
    ...
    public void loginAction() {
        ...
        try {
            ...
            // Per ora il ruolo lo forziamo se non l'ha scelto, nella realtÃƒÂ  potrebbe essere
            // un controllo extra
