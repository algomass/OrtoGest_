...
/**
 * AppStarter ÃƒÆ’Ã‚Â¨ il punto di ingresso dell'applicazione JavaFX.
 * Il suo unico scopo ÃƒÆ’Ã‚Â¨ avviare l'infrastruttura di base, configurare lo
 * SceneManager
...
public class AppStarter extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            // N.B: Uso il path in CostantiGUI perchÃƒÆ’Ã‚Â© Maven posiziona le risorse
